...
function Calculator() {
  ...
  return (
    <div className="w-auto h-screen mt-0 bg-blue-300 md:bg-blue-400">
      <div className="w-auto h-screen mt-0">
        <p className="text-center text-4xl text-green-300 md:text-lime-300 font-mono font-bold">
          Let's Calculate
        </p>
